                            ...
                            <form action="{{ route('space.update', ['id' => $space->id]) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        aria-describedby="nameHelper" value="{{ $space->name }}" placeholder="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="referenceLink" name="reference"
                                        aria-describedby="referenceHelper" value="{{ $space->reference }}" placeholder="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="address_id" id="address" class="form-control" required>
                                        ...
                                        @foreach ($addresses as $address)
                                            <option value="{{ $address->id }}" {{ $address->id == $space->address_id ? 'selected' : '' }} >{{ $address->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
